...
function XTHomeStackNavigator({ darkMode }: { darkMode: boolean }) {
  return (
    <XTHomeStack.Navigator screenOptions={{ headerShown: false }}>
      <XTHomeStack.Screen name="XTHomeTab" children={(props) => <XTHome {...props} darkMode={darkMode} />} />
      <XTHomeStack.Screen name="ChallengeDetail" children={(props) => <XTChallengeDetail {...props} darkMode={darkMode} />} />
...
function XTFriendsStackNavigator({ darkMode }: { darkMode: boolean }) {
  return (
    <XTFriendsStack.Navigator screenOptions={{ headerShown: false }}>
      <XTFriendsStack.Screen name="XTFriendsTab" children={(props) => <XTFriends {...props} darkMode={darkMode} />} />
      <XTFriendsStack.Screen name="FriendProgress" children={(props) => <XTFriendProgress {...props} darkMode={darkMode} />} />
    </XTFriendsStack.Navigator>
  )
}

function XTrackerTabs({ darkMode, toggleDarkMode }: { darkMode: boolean; toggleDarkMode: () => void }) {
  ...
  return (
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused, color, size }) => {
          const iconName = ({
            ...
            XTFriends: focused ? 'account-multiple' : 'account-multiple-outline',
    ...
    >
      <Tab.Screen name="XTHome" children={() => <XTHomeStackNavigator darkMode={darkMode} />} options={{ title: 'Home' }} />
      <Tab.Screen name="XTFriends" children={() => <XTFriendsStackNavigator darkMode={darkMode} />} options={{ title: 'Friends' }} />
      <Tab.Screen name="XTProfile" children={() => <XTProfile darkMode={darkMode} onToggleDarkMode={toggleDarkMode} />} options={{ title: 'Profile' }} />
    </Tab.Navigator>
  )
}
  ...
  return (
    <NavigationContainer>
      <RootStack.Navigator screenOptions={{ headerShown: false, animation: 'slide_from_right' }}>
        ...
        <RootStack.Screen name="XTracker" children={() => <XTrackerTabs darkMode={darkMode} toggleDarkMode={() => setDarkMode(!darkMode)} />} />
        <RootStack.Screen name="Notes" children={() => <NotesStackNavigator />} />
        <RootStack.Screen name="InstaStorySetup" component={InstaStorySetupScreen} />
        <RootStack.Screen name="InstaStoryViewer" component={InstaStoryViewerScreen} />
        <RootStack.Screen name="KeyboardControllerDemo" component={KeyboardControllerDemoScreen} />
