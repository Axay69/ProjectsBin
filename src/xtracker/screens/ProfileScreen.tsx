        ...
        <View style={styles.content}>
          <View style={[styles.card, { backgroundColor: bgColor }]}> 
            <View style={styles.userSection}>
              ...
              <View style={styles.userInfo}>
                ...
                <Text style={[styles.userHandle, { color: subTextColor }]}>@{user.username}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={[styles.card, { backgroundColor: bgColor }]}> 
            <View style={styles.setting}>
              <View style={styles.settingInfo}> 
                <MaterialCommunityIcons name="moon-stars" size={24} color="#0EA5A4" />
                <View style={styles.settingText}> 
                  <Text style={[styles.settingLabel, { color: textColor }]}>Dark Mode</Text>
                  <Text style={[styles.settingDescription, { color: subTextColor }]}>{darkMode ? "Enabled" : "Disabled"}</Text>
                </View>
              </View>
              <Switch value={darkMode} onValueChange={handleDarkModeToggle} trackColor={{ false: t.border, true: "#06B6D4" }} thumbColor={darkMode ? t.primary : "#F3F4F6"} />
          </View>
        </View>
          ...
          <View style={[styles.card, { backgroundColor: bgColor }]}> 
            ...
            <View style={styles.statsGrid}> 
              <View style={styles.stat}> 
                <Text style={[styles.statValue, { color: t.primary }]}>{friends.length}</Text>
                <Text style={[styles.statLabel, { color: subTextColor }]}>Friends</Text>
              </View>
              <View style={[styles.stat, { borderLeftWidth: 1, borderLeftColor: "#E5E7EB", paddingLeftValue: 16 }]}> 
                <Text style={[styles.statValue, { color: t.primary }]}>5</Text>
                <Text style={[styles.statLabel, { color: subTextColor }]}>Active</Text>
              </View>
            </View>
          </View>
          ...
          <View style={[styles.card, { backgroundColor: bgColor }]}> 
            ...
            <TouchableOpacity style={styles.menuItem}> 
              <MaterialCommunityIcons name="information" size={20} color={subTextColor} />
              <Text style={[styles.menuItemText, { color: textColor }]}>About xTracker</Text>
              <MaterialCommunityIcons name="chevron-right" size={20} color={subTextColor} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.menuItem}> 
              <MaterialCommunityIcons name="file-document" size={20} color={subTextColor} />
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  header: { paddingHorizontal: 20, paddingTop: 20, paddingBottom: 16, borderBottomWidth: 1, borderBottomColor: "#F3F4F6" },
  title: { fontSize: 28, fontWeight: "700" },
  content: { padding: 16 },
  card: { borderRadius: 16, padding: 16, marginBottom: 12, shadowOpacity: 0.05, shadowRadius: 2, shadowOffset: { width: 0, height: 1 }, elevation: 2 },
  ...
  logoutButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 14, marginTop: 24, borderRadius: 12, backgroundColor: "rgba(239, 68, 68, 0.1)" },
