...
export default function ChallengeCard({
  ...
  return (
    <TouchableOpacity
      style={[styles.card, { backgroundColor: cardBg, shadowColor: t.shadow }]}
      onPress={onPress}
      activeOpacity={0.7}
    >
      ...
      <View style={styles.content}>
        <View style={styles.progressContainer}>
          <View
            style={[
              styles.progressBar,
              { backgroundColor: darkMode ? '#1E2A32' : '#E5F7F7' },
            ]}
          >
            <View
              style={[
                styles.progressFill,
                { width: `${percentage}%`, backgroundColor: t.primary },
              ]}
            />
          </View>
          <Text style={[styles.percentText, { color: subTextColor }]}>
            {percentage}%
          </Text>
        </View>
