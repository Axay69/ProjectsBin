...
export default function ReanimatedExpanderScreen(_: Props) {
  ...
  const sentence =
    'This text fades and slides using entering/exiting animations. This text fades and slides using entering/exiting animations. This text fades and slides using entering/exiting animations. This text fades and slides using entering/exiting animations.';
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1 }}>
              ...
              >
                ...
                >
                  ...
                  {isOpen && (
                    ...
                    >
                      <Text style={styles.expanderText}>
                        Answer text that animates open and closed.
                      </Text>
                    </Animated.View>
                  )}
                </Pressable>
        ...
        <Animated.View layout={Layout.duration(400)}>
          ...
          >
            ...
            >
              <Text style={styles.expanderHeader}>
                Animated Text — {open2 ? 'collapse' : 'expand'}
              </Text>
              {open2 && (
                <Animated.Text
                  layout={Layout.duration(400)}
        ...
        <Animated.View layout={Layout.duration(400)}>
          ...
          >
            ...
            >
              <Text style={styles.expanderHeader}>
                Image Preview — {imageOpen ? 'collapse' : 'expand'}
              </Text>
              {imageOpen && (
                <Animated.View
        ...
        <Animated.View layout={Layout.duration(500).delay(imageOpen ? 100 : 0)}>
          <Pressable
            accessibilityRole="button"
            onPress={() => setVideoOpen(s => !s)}
          >
            <Animated.View layout={Layout.springify()} style={styles.expander}>
              <Text style={styles.expanderHeader}>
                Video Preview — {videoOpen ? 'collapse' : 'expand'}
              </Text>
              {videoOpen && (
                <Animated.View
                  entering={FadeIn.duration(200)}
