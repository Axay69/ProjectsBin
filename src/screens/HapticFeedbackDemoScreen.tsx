...
export default function HapticFeedbackDemoScreen({}: Props) {
  const options = { enableVibrateFallback: true, ignoreAndroidSystemSettings: true }
...
const styles = StyleSheet.create({
  ...
  list: { gap: 12 },
  button: { paddingVertical: 12, paddingHorizontal: 14, backgroundColor: '#111827', borderRadius: 10 },
