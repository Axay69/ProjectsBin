...
type Props = NativeStackScreenProps<RootStackParamList, 'ReanimatedEnteringExiting'>
...
export default function ReanimatedEnteringExitingScreen(_: Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.desc}>Animate mount and unmount to avoid pop-in.</Text>
      ...
      <View style={styles.boxArea}>
        {showBox && <Animated.View entering={FadeIn} exiting={FadeOut} style={styles.box} />}
      </View>
    </View>
  )
}
