...
export default function TableComponentDemoScreen() {
  ...
  const addScore = (id: number, delta = 5) => {
    setRows(prev =>
      prev.map(r => (r.id === id ? { ...r, score: r.score + delta } : r)),
    );
  };
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
                ...
                <Cell
                  ...
                  data={
                    <TouchableOpacity
                      style={[
                        styles.statusChip,
                        r.status === 'Active' ? styles.active : styles.paused,
                      ]}
        ...
        <View style={styles.tableBox}>
          <Table borderStyle={{ borderWidth: 1, borderColor: '#e5e7eb' }}>
            ...
            <TableWrapper style={styles.wrapper}>
              <Col
                data={names}
                heightArr={Array(names.length).fill(48)}
                textStyle={styles.text}
                width={140}
              />
              <Rows
      ...
      <View style={styles.customBox}>
        ...
        {rows.map((r, i) => (
          <View
            key={`custom-${r.id}`}
            style={[styles.customRow, i % 2 === 1 && styles.customRowAlt]}
          >
            ...
            <TouchableOpacity
              style={[styles.rowActionBtn, { flex: 1 }]}
              onPress={() => addScore(r.id)}
            >
