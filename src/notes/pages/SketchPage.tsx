    ...
    try {
      ...
      if (!id) {
        const created = add({
          ...
          content: '',
          tags: [],
          color: pickNoteColor(colorMode, fixedColor),
          media: [item],
        });
        id = created.id;
      } else {
          ...
          {notePalette.slice(0, 6).map(c => (
            <TouchableOpacity
              ...
              style={[
                ...
                {
                  backgroundColor: c,
                  borderColor: strokeColor === c ? theme.primary : theme.border,
                  borderWidth: strokeColor === c ? 3 : 1,
                },
              ]}
            />
          ))}
          <TouchableOpacity
            ...
            style={[
              styles.colorSwatch,
              {
                ...
                borderColor:
                  strokeColor === theme.text ? theme.primary : theme.border,
                borderWidth: strokeColor === theme.text ? 3 : 1,
              },
            ]}
          />
        </View>
