import { View, Text, StyleSheet, TouchableOpacity, Image, StatusBar, Dimensions, Platform } from 'react-native'
...
export default function MediaPreview({ media, visible, onClose }: Props) {
  ...
  return (
    <Modal isVisible={visible} onBackdropPress={onClose} useNativeDriver statusBarTranslucent style={[styles.modal, {
      flex: 1,backgroundColor: 'red'
    }]}>
      <View style={[styles.overlay, { 
        // backgroundColor: theme.bg
         }]}>
        <TouchableOpacity activeOpacity={0.7} onPress={onClose} style={[styles.closeIconBtn, { backgroundColor: theme.surface }]}> 
...
const styles = StyleSheet.create({
  ...
  videoControls: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 16, paddingHorizontal: 16 },
  ...
  closeIconBtn: { position: 'absolute', top: 12, right: 12, width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', zIndex: 10 },
